...
#define buzzer 15 // define o pino 15  para o buzzer
#define sinal_sensor A15 // define o pino A15 para a entrada de sinal
#define led_alarme 16 // define o pino 16 para o ledr de alarme
...
byte pinosLinhas[] = {A14, A13, A12, A11}; // cria um vetor de 4 colunas
byte pinosColunas[] = { A10, A9, A8, A7}; // cria um vetor de 4 colunas

char senha[4] = {'1','2','3','4'}; // cria um vetor char de nome senha de 4 colunas com caracteres definidos
...
LiquidCrystal lcd(8, 9, 4, 5, 6, 7);  // define os pinos para comunicação com o display lcd
